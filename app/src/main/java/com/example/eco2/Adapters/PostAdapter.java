...
import com.example.eco2.CommentActivity;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull final Viewholder holder, int position) {
        ...
        String formattedDateTime = post.getDay() + " " + post.getMonth() + " " + post.getYear()  + " at " + formatTime(post.getTime());
    ...
    private String formatTime(String time24) {
        try {
            ...
            e.printStackTrace();
            return time24; // Return the original time if parsing fails
        }
    }
